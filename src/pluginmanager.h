...
#ifndef PANA_PLUGINMANAGER_H
#define PANA_PLUGINMANAGER_H
...
class PluginManager
{
    public:
        ...
        static const int FrameworkVersion = 32;
         ...
         * @see               http://developer.kde.org/documentation/library/kdeqt/tradersyntax.html
         */
        static Pana::Plugin* createFromQuery( const QString& constraint = QString::null );
         ...
         * @return            Pointer to Plugin, or NULL if error
         */
        static Pana::Plugin* createFromService( const KService::Ptr service );

        /**
         * Remove library and delete plugin
         * @param plugin      Pointer to plugin
         */
        static void unload( Pana::Plugin* plugin );
         ...
         */
        static KService::Ptr getService( const Pana::Plugin* plugin );
    ...
    private:
        ...
        static std::vector<StoreItem>::iterator lookupPlugin( const Pana::Plugin* plugin );
