...
public:
    ...
    */
    LIBPANA_EXPORT static bool isAvailable();
    ...
    */
    LIBPANA_EXPORT void exportTracks( const KURL::List &urls, int openmode=-1 );
...
private:
    ...
    LIBPANA_EXPORT static K3bExporter *s_instance;
};
