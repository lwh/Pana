/***************************************************************************
                         panadcophandler.cpp  -  DCOP Implementation
                            -------------------
...
/////////////////////////////////////////////////////////////////////////////////////
        ...
        , QObject( kapp )
    {
        ...
        if ( !kapp->dcopClient()->isRegistered() ) {
            kapp->dcopClient()->registerAs( "pana", false );
    ...
    {
        PanaConfig::setContextBrowserStyleSheet( msg );
        ContextBrowser::instance()->reloadStyleSheet();

        if ( QFile::exists( Pana::saveLocation( "themes/" + msg + '/' ) + "stylesheet.css" ) )
    ...
    {
        Pana::OSD::instance()->setEnabled( enable );
        PanaConfig::setOsdEnabled( enable );
    }

    void DcopPlayerHandler::enableRandomMode( bool enable )
    {
        static_cast<KSelectAction*>(Pana::actionCollection()->action( "random_mode" ))
            ->setCurrentItem( enable ? PanaConfig::EnumRandomMode::Tracks : PanaConfig::EnumRandomMode::Off );
    }

    void DcopPlayerHandler::enableRepeatPlaylist( bool enable )
    {
        static_cast<KSelectAction*>( Pana::actionCollection()->action( "repeat" ) )
               ->setCurrentItem( enable ? PanaConfig::EnumRepeat::Playlist : PanaConfig::EnumRepeat::Off );
    }

     void DcopPlayerHandler::enableRepeatTrack( bool enable)
    {
        static_cast<KSelectAction*>( Pana::actionCollection()->action( "repeat" ) )
               ->setCurrentItem( enable ? PanaConfig::EnumRepeat::Track : PanaConfig::EnumRepeat::Off );
    }
    ...
    void DcopPlayerHandler::setEqualizerEnabled( bool active )
    {
        ...
        PanaConfig::setEqualizerEnabled( active );
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    QString DcopScriptHandler::readConfig(const QString& key)
    {
        ...
        KConfigSkeletonItem* configItem = PanaConfig::self()->findItem(cleanKey.remove(' '));
        if (configItem)
