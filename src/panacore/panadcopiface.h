 ...
 * (C) 2005 Ian Monroe
 * (C) 2005 Seb Ruiz berkus@users.sf.net
 *
...
#ifndef PANA_DCOPIFACE_H
#define PANA_DCOPIFACE_H
...
///////////////////////////////////////////////////////////////////////
// WARNING! Please ask on #pana before modifying the DCOP interface!
///////////////////////////////////////////////////////////////////////


class PanaPlayerInterface : virtual public DCOPObject
{
   K_DCOP

k_dcop:
   virtual QString version() = 0;                           ///< returns pana version string
...
class PanaPlaylistInterface : virtual public DCOPObject
{
   K_DCOP
...
class PanaPlaylistBrowserInterface : virtual public DCOPObject
{
   K_DCOP
...
class PanaContextBrowserInterface : virtual public DCOPObject
{
   K_DCOP
...
class PanaCollectionInterface : virtual public DCOPObject
{
   K_DCOP
...
k_dcop:
   ...
   virtual QString relativePath( const QString &url ) = 0; ///< Returns the relative path used in Pana's database
   virtual QString absolutePath( int deviceid, const QString &relativePath ) = 0; ///< Returns the absolute path
};


class PanaScriptInterface : virtual public DCOPObject
{
   K_DCOP
...
k_dcop:
   ...
   virtual QString readConfig(const QString& key) = 0; ///< returns a PanaConfig configuration entry value from the given key
   virtual QStringList readListConfig(const QString& key) = 0; ///< PanaConfig lists must use this function
...
class PanaDevicesInterface : virtual public DCOPObject
{
   K_DCOP
...
class PanaMediaBrowserInterface : virtual public DCOPObject
{
    K_DCOP
