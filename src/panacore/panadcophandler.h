...
#ifndef PANA_DCOP_HANDLER_H
#define PANA_DCOP_HANDLER_H

#include <qobject.h>
#include "panadcopiface.h"
class PanaConfig;

namespace Pana
{

class DcopPlayerHandler : public QObject, virtual public PanaPlayerInterface
{
      Q_OBJECT
...
class DcopPlaylistHandler : public QObject, virtual public PanaPlaylistInterface
{
        Q_OBJECT
...
class DcopPlaylistBrowserHandler : public QObject, virtual public PanaPlaylistBrowserInterface
{
        Q_OBJECT
...
class DcopContextBrowserHandler : public QObject, virtual public PanaContextBrowserInterface
{
        Q_OBJECT
...
class DcopCollectionHandler : public QObject, virtual public PanaCollectionInterface
{
   Q_OBJECT
...
class DcopScriptHandler : public QObject, virtual public PanaScriptInterface
{
   Q_OBJECT
...
class DcopDevicesHandler : public QObject, virtual public PanaDevicesInterface
{
   Q_OBJECT
...
class DcopMediaBrowserHandler : public QObject, virtual public PanaMediaBrowserInterface
{
    Q_OBJECT
