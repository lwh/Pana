...
#ifndef PANA_EQUALIZERSETUP_H
#define PANA_EQUALIZERSETUP_H
...
class EqualizerSetup : public KDialogBase
{
    ...
    private:
        ...
        Pana::Slider* m_slider_preamp;
        EqualizerGraph* m_equalizerGraph;
        QPtrList<Pana::Slider> m_bandSliders;
