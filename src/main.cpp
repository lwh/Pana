 ...
 *
 * Please see top level COPYING file for licence. 
 */
...
//#define PANA_USE_DRKONQI

extern class KAboutData aboutData; //defined in panacore/app.cpp
...
int main( int argc, char *argv[] )
{
	...
	aboutData.addAuthor( "Paul '" I18N_NOOP("Meet me at the Pana Bar!") "' Cifarelli",
...
#ifdef Q_WS_X11
    #ifndef PANA_USE_DRKONQI
    KCrash::setCrashHandler( Pana::Crash::crashHandler );
    #endif
#endif
    return app.exec();
}
