...
#ifndef PANA_MEDIABROWSER_H
#define PANA_MEDIABROWSER_H
...
class LIBPANA_EXPORT MediaItem : public KListViewItem
{
    public:
...
class MediaBrowser : public QVBox
{
    ...
    public:
        ...
        LIBPANA_EXPORT static MediaBrowser *instance() { return s_instance; }
        LIBPANA_EXPORT static MediaQueue *queue() { return s_instance ? s_instance->m_queue : 0; }
        ...
        QString getDisplayPluginName ( const QString string ) { return m_pluginPanaName[string]; }
...
class MediaView : public KListView
{
    ...
    public:
        ...
        virtual ~MediaView();
        LIBPANA_EXPORT KURL::List nodeBuildDragList( MediaItem* item, int flags=OnlySelected );
        int getSelectedLeaves(MediaItem *parent, QPtrList<MediaItem> *list, int flags=OnlySelected );
        LIBPANA_EXPORT MediaItem *newDirectory( MediaItem* parent );
...
class LIBPANA_EXPORT MediaDevice : public QObject, public Pana::Plugin
{
    Q_OBJECT
    friend class DeviceConfigureDialog;
