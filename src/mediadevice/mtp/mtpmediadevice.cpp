...
PANA_EXPORT_PLUGIN( MtpMediaDevice )
...
MtpMediaDevice::rmbPressed( QListViewItem *qitem, const QPoint &point, int )
{
    ...
    if( item )
    {
        ...
        case MediaItem::TRACK:
            ...
            menu.insertItem( SmallIconSet( Pana::icon( "covermanager" ) ), i18n( "Refresh Cover Images" ), UPDATE_ALBUM_ART );
            break;
        case MediaItem::PLAYLIST:
...
/**
 * Load config from the panarc file
 */
void
