...
#ifndef PANA_COLLECTIONBROWSER_H
#define PANA_COLLECTIONBROWSER_H
...
class CollectionView : public KListView, public DropProxyTarget
{
    ...
    public:
        ...
        LIBPANA_EXPORT static CollectionView* instance() { return m_instance; }
    ...
    public slots:
        ...
        void organizeFiles( const KURL::List &list, const QString &caption, bool addToCollection=false ) LIBPANA_EXPORT;
    ...
    private slots:
        ...
        /** Tries to download the cover image from last.fm */
        void fetchCover();
    ...
    //attributes:
        LIBPANA_EXPORT static CollectionView* m_instance;
...
#endif /* PANA_COLLECTIONBROWSER_H */
