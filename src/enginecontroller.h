...
#ifndef PANA_ENGINECONTROLLER_H
#define PANA_ENGINECONTROLLER_H
...
/**
 * This class captures Pana specific behaviour for some common features.
...
public:
    ...
    LIBPANA_EXPORT static bool installDistroCodec(const QString& engine /*Filetype type*/);
