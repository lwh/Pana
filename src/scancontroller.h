...
#ifndef PANA_SCANCONTROLLER_H
#define PANA_SCANCONTROLLER_H
 ...
 * @short Starts and controls the external panacollectionscanner application.
 * @author Mark Kretschmann <markey@web.de>
 *
 * The collection scanner itself is run in an external process, unlike before, where it
 * used to be thread. The advantage is that the scanner cannot crash the pana main
 * application any more. If it crashes we can simply restart it.
 *
 * pana communicates with the scanner via the ScanController class, which processes
