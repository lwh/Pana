...
#ifndef PANA_PLAYLIST_H
#define PANA_PLAYLIST_H
...
class Playlist : private KListView, public EngineObserver, public Pana::ToolTipClient
{
        Q_OBJECT
    ...
    public:
        ...
        LIBPANA_EXPORT static Playlist *instance() { return s_instance; }
        ...
        LIBPANA_EXPORT void insertMedia( const KURL::List &, int options = Append );
        ...
        LIBPANA_EXPORT bool isTrackBefore() const;
        LIBPANA_EXPORT bool isTrackAfter()  const;
        ...
        bool saveM3U( const QString&, bool relative = PanaConfig::relativePlaylist() ) const;
        ...
        friend void Pana::DcopPlaylistHandler::removeCurrentTrack(); //calls removeItem() and currentTrack()
        friend void Pana::DcopPlaylistHandler::removeByIndex( int ); //calls removeItem()
    ...
    private:
        ...
        LIBPANA_EXPORT static Playlist *s_instance;
