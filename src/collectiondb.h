...
#ifndef PANA_COLLECTIONDB_H
#define PANA_COLLECTIONDB_H
...
class LIBPANA_EXPORT CollectionDB : public QObject, public EngineObserver
{
    Q_OBJECT
    ...
    signals:
        ...
        void coverFetched( const QString &artist, const QString &album ); //only when fetching from Lastfm
    ...
    public:
        ...
        /**
         * converts the result list of a pana-sql query to a list of urls
         */
        ...
        QString findLastfmImage( const QString &artist, const QString &album, const uint width = 1 );
    ...
    private:
        ...
        //helper methods which perform updates of pana's database
        ...
        //member variables
        QString m_LastfmLicense; // Need this ? PANAFIX
