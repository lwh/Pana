...
#ifndef PANAMAGNATUNEBROWSER_H
#define PANAMAGNATUNEBROWSER_H
...
/**
Pana browser that displays all the music available at magnatune.com and makes it available for previewing and purchasing.
