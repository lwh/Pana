...
namespace Pana { class PrettySlider; }
class KAction;
class MetaBundle;
class PlayerWidget;
class QBitmap;
...
class PlayerWidget : public QWidget, public EngineObserver
{
    ...
    public:
        ...
        /** Set modified Pana palette */
        void setModifiedPalette();
        /** Call after some Pana setting have changed */
        void applySettings();
        ...
        /** Determines Pana colours for current KDE scheme */
        static void determinePanaColors();
    ...
    private:
        ...
        Pana::PrettySlider *m_pSlider;
        Pana::PrettySlider *m_pVolSlider;
