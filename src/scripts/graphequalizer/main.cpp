...
static const char description[] =
    I18N_NOOP("An Pana Equalizer using a line graph");
...
int main(int argc, char **argv)
{
    KAboutData about("Graph Equalizer", I18N_NOOP("Graph Equalizer"), version, description,
             KAboutData::License_GPL_V2, "(C) 2005 Ian Monroe", 0, 0, "ian@monroe.nu");
...
//    app.setMainWidget( mainWin );
    ...
    CallPana* ca = new CallPana(mainWin,"ca", mainWin->canvasView,mainWin->preampSlider);
