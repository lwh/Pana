...
require 'Qt'
require "#{File.dirname( File.expand_path(__FILE__))}/pana.rb"

#a simple method to call DCOP. If you use Korundum, you can use
#dR = KDE::DCOPRef.new("pana", "player"); dR.artist instead
def dcop (val1, val2 = String.new)
	str =`dcop pana player #{val1} #{val2}`
...
PanaCommunication = AmaroKLib.new(a, e)
a.exec()
