...
if [ `/usr/bin/whoami` = 'root' ]; then
	...
	kdialog --title "pana livecd remaster" --msgbox "The music that you added is now being squashed and added to the livecd. Please be VERY patient as this step can take a LONG time."
	...
	kdialog --title "pana livecd remaster" --yesno "Livecd creation is done. The new pana live image is in `pwd`, called pana.live.custom.iso. You can burn that with any standard burner and enjoy.
