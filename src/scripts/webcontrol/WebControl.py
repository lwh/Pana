...
############################################################################
# Based on
# Python-Qt template script for Pana
...
class ConfigDialog( QDialog ):
    ...
    def __init__( self ):
        ...
        self.setCaption( "WebControl - Pana" )

        self.config = ConfigParser.ConfigParser()

        allowControl = RequestHandler.PanaStatus.allowControl
	publish = RequestHandler.PanaStatus.publish
        try:
...
class WebControl( QApplication ):
    ...
    def readSettings( self ):
        ...
        try:
            RequestHandler.PanaStatus.allowControl = string.find(config.get( "General", "allowcontrol" ), "True") >= 0
            RequestHandler.PanaStatus.publish = string.find(config.get( "General", "publish" ), "True") >= 0
        except:
    ...
    def zeroconfPublishing( self ):
        if RequestHandler.PanaStatus.publish:
...
# events from Pana:
    ...
    def engineStatePlay( self ):
        ...
        RequestHandler.PanaStatus.dcop_trackcurrenttime = Globals.PlayerDcop("trackCurrentTime")
        RequestHandler.PanaStatus.dcop_trackcurrenttime.result()
        RequestHandler.PanaStatus.dcop_tracktotaltime = Globals.PlayerDcop("trackTotalTime")
        RequestHandler.PanaStatus.dcop_tracktotaltime.result()
        RequestHandler.PanaStatus.playState = RequestHandler.PanaStatus.EnginePlay

    def engineStateIdle( self ):
        """ Called when Engine state changes to Idle """
        RequestHandler.PanaStatus.playState = RequestHandler.PanaStatus.EngineIdle

    def engineStatePause( self ):
        """ Called when Engine state changes to Pause """
        RequestHandler.PanaStatus.playState = RequestHandler.PanaStatus.EnginePause

    def engineStateEmpty( self ):
        """ Called when Engine state changes to Empty """
        RequestHandler.PanaStatus.playState = RequestHandler.PanaStatus.EngineEmpty

    def trackChange( self ):
        """ Called when a new track starts """
        RequestHandler.PanaStatus.dcop_trackcurrentindex = Globals.PlaylistDcop("getActiveIndex")
        RequestHandler.PanaStatus.dcop_trackcurrentindex.result()
        RequestHandler.PanaStatus.dcop_trackcurrenttime = Globals.PlayerDcop("trackCurrentTime")
        RequestHandler.PanaStatus.dcop_trackcurrenttime.result()
        RequestHandler.PanaStatus.dcop_tracktotaltime = Globals.PlayerDcop("trackTotalTime")
        RequestHandler.PanaStatus.dcop_tracktotaltime.result()
