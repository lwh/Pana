...
#ifndef PANA_STATUSBAR_H
#define PANA_STATUSBAR_H
...
namespace Pana
{
    ...
    class StatusBar : public KDE::StatusBar, public EngineObserver
    {
        ...
        LIBPANA_EXPORT static StatusBar* s_instance;
...
namespace The
{
    inline Pana::StatusBar *statusbar() { return Pana::StatusBar::instance(); }
}
