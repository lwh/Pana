...
#include "pana.h"
#include "panaconfig.h"     //check if dynamic mode
#include "playlist.h"
    ...
    : KDialogBase( KDialogBase::Swallow, 0, parent, name, false, 0, Ok|Apply|Cancel )
{
    ...
    m_remove = new KPushButton( KGuiItem( QString::null, Pana::icon( "dequeue_track" ) ), buttonBox );
    m_add    = new KPushButton( KGuiItem( QString::null, Pana::icon( "queue_track" ) ), buttonBox );
    m_clear  = new KPushButton( KGuiItem( QString::null, Pana::icon( "playlist_clear" ) ), buttonBox );
