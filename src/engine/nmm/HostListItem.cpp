...
QPixmap* HostListItem::pixmapVolume( int type )
{
  if( type == PixInset )
  {
    static QPixmap m_pixmapInset( locate( "data", "pana/images/nmm-volume-inset.png" ) );
...
QPixmap HostListItem::generateGradient( int type )
{
  ...
  if( type == PixRight )
    temp = QPixmap( locate( "data", "pana/images/nmm-gradient-right.png" ) );
  else // PixLeft
    temp = QPixmap( locate( "data", "pana/images/nmm-gradient-left.png" ) );
