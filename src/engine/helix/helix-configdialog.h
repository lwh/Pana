...
Q_OBJECT
public:
   HelixConfigEntry( QWidget *parent, Pana::PluginConfig*,
                     int row, const QString & description, const char *defaultvalue, const QString & tooltip );
   HelixConfigEntry( QWidget *parent, QString &str, Pana::PluginConfig*,
                     int row, const QString & description, const char *defaultvalue, const QString & tooltip );
...
Q_OBJECT
public:
   HelixSoundDevice( QWidget *parent, Pana::PluginConfig *config, int &row, HelixEngine *engine );
   bool save();
...
{
public:
   HelixConfigDialogBase( HelixEngine *engine, Pana::PluginConfig *config, QWidget *parent = 0 );
...
class HelixConfigDialog : public Pana::PluginConfig
{
public:
