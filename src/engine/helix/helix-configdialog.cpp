...
HelixConfigEntry::HelixConfigEntry( QWidget *parent,
                                    Pana::PluginConfig *pluginConfig,
                                    int row,
...
HelixConfigDialogBase::HelixConfigDialogBase( HelixEngine *engine, Pana::PluginConfig *config, QWidget *p )
     : QTabWidget( p )
     , m_core(0)
     , m_plugin(0)
     , m_codec(0)
...
HelixConfigDialog::HelixConfigDialog( HelixEngine *engine, QWidget *p ) : Pana::PluginConfig()
{
   if (!instance)
