...
void Options5::init()
{
    ...
    m_pOSDPreview->setAlignment( static_cast<OSDWidget::Alignment>( PanaConfig::osdAlignment() ) );
    m_pOSDPreview->setOffset( PanaConfig::osdYOffset() );
