...
#ifndef PANA_EDITFILTERDIALOG_H
#define PANA_EDITFILTERDIALOG_H
...
class EditFilterDialog : public KDialogBase
{
    ...
    private:
        ...
        QValueVector<QString> m_vector; // the vector of the pana filter keyword
