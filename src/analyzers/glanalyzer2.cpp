...
Analyzer::Base3D(parent, 15)
{
    ...
    makeCurrent();
    loadTexture( locate("data","pana/data/dot.png"), dotTexture );
    loadTexture( locate("data","pana/data/wirl1.png"), w1Texture );
    loadTexture( locate("data","pana/data/wirl2.png"), w2Texture );
