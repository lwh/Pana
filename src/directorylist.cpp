        ...
        : QVBox( parent, "CollectionSetup" )
{
    ...
    QToolTip::add( m_recursive, i18n( "If selected, Pana will read all subfolders." ) );
    ...
    m_recursive->setChecked( PanaConfig::scanRecursively() );
    m_monitor->setChecked( PanaConfig::monitorChanges() );
...
CollectionSetup::writeConfig()
{
    ...
    PanaConfig::setScanRecursively( recursive() );
    PanaConfig::setMonitorChanges( monitor() );
}
