...
class LIBPANA_EXPORT MetaBundle
{
...
public:
    ...
    class LIBPANA_EXPORT EmbeddedImage {
    public:
        EmbeddedImage() {}
    ...
    LIBPANA_EXPORT MetaBundle( const MetaBundle &bundle );
