...
{
    const KAboutData about( "panacollectionscanner",
    I18N_NOOP( "Pana Collection Scanner\n\nNote: For debugging purposes this application can be invoked from the command line, but it will not actually build a collection this way." ), "0.1",
    I18N_NOOP( "Collection Scanner for Pana" ), KAboutData::License_GPL_V2,
    I18N_NOOP( "(C) 2010 The Pana Developers" ),
    I18N_NOOP( "IRC:\nserver: irc.freenode.net #pana\n\nFeedback:\npana@bunnies.net" ),
    I18N_NOOP( "http://pana.bunnies.net" ) );
