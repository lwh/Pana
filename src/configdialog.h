...
#ifndef PANACONFIGDIALOG_H
#define PANACONFIGDIALOG_H
...
class PanaConfigDialog : public KConfigDialog
{
    Q_OBJECT

    public:
        PanaConfigDialog( QWidget *parent, const char* name, KConfigSkeleton *config );
        ~PanaConfigDialog();
    ...
    private:
        ...
        Pana::PluginConfig *m_engineConfig;
